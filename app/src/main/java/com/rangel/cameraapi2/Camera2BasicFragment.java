...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public static final int MY_WRITE_EXTERNAL_STORAGE = 19;
        ...
        mHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (canvas == null) {
                    ...
                    //canvas.drawRect(100, 100, 1000, 1100, myPaint);
                    canvas.drawRect(iniciotouchX, iniciotouchY, touchX, touchY, myPaint);
                    Toast.makeText(getContext(), "iniciotouchX: " + iniciotouchX + " iniciotouchY:" + iniciotouchY + " touchX:" + touchX + " touchY:" + touchY, Toast.LENGTH_SHORT).show();
...
//                        canvasBitmap = Bitmap.createBitmap(mTextureView.getWidth(), mTextureView.getHeight(), Bitmap.Config.ARGB_8888);
    ...
    private void openCamera(int width, int height) {
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), android.Manifest.permission.CAMERA)) {
                ...
                ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_WRITE_EXTERNAL_STORAGE);
            }
        }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    //unlockFocus();
                    Intent editPhoto = new Intent(getContext(), com.rangel.cameraapi2.EditPhoto.class);
                    editPhoto.putExtra("direcionFile",mFile.getAbsolutePath());
